...
public class BaseDaoImpl<T extends Serializable> implements BaseDao<T> {
	...
	private int getParameterType(Object param) {
        ...
        for (Class cls : clss) {
            if (cls == Collection.class || cls == List.class) return 1;
        }
        return 0;
    }
	 ...
	 * @return
	 */
	public PagedObject getPagedObject(String sql, Integer first, Integer max, Map<String, Object> params) {
    	if (first == null) {
    		first = 0;
    	}
    	if (max == null) {
	 ...
	 * @return
	 */
	public PagedObject getPagedObject(StringBuilder sql, Integer first, Integer max, Map<String, Object> params) {
