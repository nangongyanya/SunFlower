	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<c:import url="/pages/inc/inc_breadcrumbs.jsp?menu=功能菜单管理" />

				<div class="page-content">
					<div class="page-header">
						<h1>
							系统功能<small><i class="ace-icon fa fa-angle-double-right"></i></small>
							 权限管理 <small> <i class="ace-icon fa fa-angle-double-right"></i> 功能菜单管理 </small>
						</h1>
					</div>
					...
					<div class="row">
						<div class="col-xs-2" style="padding-left: 0; padding-right: 0;">
							<iframe name="leftFrame" id="leftFrame" height="500px" width="100%" 
            					src="/system/admin/adminMenus_left.h" border="0" frameborder="0" scrolling="auto">
				                	浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
				            </iframe>
						</div>
						<div class="col-xs-10">
							<iframe name="rightFrame" id="rightFrame" height="500px" width="100%"  
            	 				src="/system/admin/adminMenu_list.h" border="0" frameborder="0" >
                					浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
           	 				</iframe>
						</div>
					</div>
