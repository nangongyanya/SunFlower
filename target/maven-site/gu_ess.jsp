			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">Sunflower</span>
								<span class="white" id="id-text2">后台登陆</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; 蓝绢科技</h4>
						</div>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			$("form").submit(function () {
                ...
                $("form").attr("action", "<c:url value='/system/login.h'/>");
            })
		});
